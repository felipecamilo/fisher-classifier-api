...
por isso os dados são geralmente projetados em sub-espaços de baixa dimensionalidade; no caso de menos que 4 dimensões podemos visualizar todo o sub-espaço e até mesmo classificar novas observações a olho!

No nosso modelo com Breast Cancer Wsosdssauiibn temos somente uma componente discriminante
